...
## Switches
set_property PACKAGE_PIN V17 [get_ports {modi}]
	set_property IOSTANDARD LVCMOS33 [get_ports {modi}]
#set_property PACKAGE_PIN V16 [get_ports {double_t_period}]
	#set_property IOSTANDARD LVCMOS33 [get_ports {double_t_period}]
